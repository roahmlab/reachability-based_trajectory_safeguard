classdef rlSARSAAgent < rl.agent.AbstractAgent
    ...
    methods
        function this = rlSARSAAgent(Critic, Option)
            % Constructor
        ...
        function set.AgentOptions(this,NewOptions)
            validateattributes(NewOptions,{'rl.option.rlSARSAAgentOptions'},{'scalar'},'','AgentOptions');
    ...
    methods (Access = protected)
        ...
        function NextAction = learn(this,exp)
            ...
            NextAction = getActionWithExploration(this,NextObservation);
            ...
            if Done == 1
                ...
                TargetQValue = getValue(this.Critic,NextObservation,NextAction);
    ...
    methods (Hidden)
        function actor = getActor(~)
            % getActor: SARSA agent does not have actor. Therefore, it
            % returns empty.            
    ...
    methods (Static)
        function obj = loadobj(s)
            if isstruct(s)
                ...
                obj = rl.agent.rlSARSAAgent(s.Critic,s.AgentOptions_);
