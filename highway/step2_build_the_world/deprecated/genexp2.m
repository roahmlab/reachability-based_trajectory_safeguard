...
P = zonotope_planner_sim('t_move',t_move,'t_plan',t_plan);
...
% %%
% actorNetwork = [
%     imageInputLayer([5 1],'Normalization','none','Name','observation')
...
simOptions = rlSimulationOptions('MaxSteps',600,'NumSimulations',1,'UseParallel',0);
...
%%
% save("agent_after_N_Mode_7.9.mat","agent","trainingStats")
%%
