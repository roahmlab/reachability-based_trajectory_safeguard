function dz = closed_loop_highwaySS_brake(tdummy,z,udummy)
...
% options.x0 = [0;0;0;kvc;0;    kvc;   kyc];
            ...
            vx_nom = z(6)*(-1/(1+exp(-5*(t-1.3+0.5)))+1);%*(udummy-t)/udummy; % this is the output from network,network output discrete, converted to num by planner
