classdef CartPoleVisualizerLimitedTrackNew < AbstractFigureVisualizerNew
% CARTPOLEVISUALIZER

% Copyright 2018 The MathWorks, Inc.

    methods
        function this = CartPoleVisualizerLimitedTrackNew(A)
            this = this@AbstractFigureVisualizerNew(A);
        end
    end
