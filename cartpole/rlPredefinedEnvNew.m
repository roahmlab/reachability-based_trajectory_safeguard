function env = rlPredefinedEnvNew(keyword)
...
switch keyword
    ...
    case lower('CartPole-Continuous-new')
        env = CartPoleContinuousActionNew; 
    case lower('CartPole-ContinuousLimitedTrack')
        env = CartPoleContinuousLimitedTrack;
